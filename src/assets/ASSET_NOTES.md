# Eldertide Isles Asset Notes

These assets are custom generated for this prototype and optimized into small WebP files for the mobile tester build.

- `forge-scene-bg.webp`: island forge playfield background with anvil, lighthouse, reef glow, and forge fire.
...
The source generations used a flat magenta chroma-key background for sprite extraction. Final shipped files are cropped, alpha-preserving WebP assets.
